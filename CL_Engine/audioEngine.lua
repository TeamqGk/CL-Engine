...
function audioEngine.addMusic(pFile, pLoop, pVolume, pPlay)
  local new = {}
...
function audioEngine.addSound(pFile, pLoop, pVolume)
  local new = {}
  new.source = love.audio.newSource(pFile, "stream")
  new.source:setLooping(pLoop)
...
function audioEngine.setVolume(pVolume)
  ...
  print("error, you need use cl.audioEngine.setVolume( 0 to 1) // example : 0 = 0 %; 0.5 = 50 %; 1 = 100 %")
end
--
